  ...
  return (
    ...
    >
      <div
        ...
        style={{ background: 'radial-gradient(circle, #a8dadc 0%, transparent 70%)' }}
      />
      <div
        aria-hidden
        className="pointer-events-none fixed bottom-[-80px] left-[-80px] w-[360px] h-[360px] rounded-full opacity-20"
